...
public class BranchScript1 : MonoBehaviour
{
    private Transform _transform;
    private ForestController1 _controller;
    ...
    private void Start()
    {
        _controller = GameObject.Find("Forest Controller1").GetComponent<ForestController1>();
