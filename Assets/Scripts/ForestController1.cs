...
public class ForestController1 : MonoBehaviour
{
    public float maxSap;
    ...
    {
        var branchScript1 = mouseRayTarget.collider.GetComponent<BranchScript1>();
        branchScript1.IsGrowing = true;
    }
    ...
    private void DestroyBranchIfAbovePlayer(GameObject branch)
    {
        ...
        {
            var branchScript1 = branch.GetComponent<BranchScript1>();
            branchScript1.FadeAndDestroy();
        }
    }
