...
public class ForestController2 : MonoBehaviour
{
    public float maxSap;
    ...
    {
        var branchScript2 = mouseRayTarget.collider.GetComponent<BranchScript2>();
        branchScript2.IsGrowing = true;
    }
    ...
    private void DestroyBranchIfAbovePlayer(GameObject branch)
    {
        ...
        {
            var branchScript2 = branch.GetComponent<BranchScript2>();
            branchScript2.FadeAndDestroy();
        }
    }
